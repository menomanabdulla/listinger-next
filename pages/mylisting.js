          ...
          <div className="col">
              <div className="lg-dash-listings">
                  <div className="my-listings-head">
                      <span><i className="la la-fire"></i>All Listings</span>
                  </div>
                  <div className="my-listings-body">
                      <div className="table-wrap">
                          ...
                          <tbody>
                              ...
                              <td className="date"><span>24 Jan, 2018</span></td>
                              <td className="expire-date"><span>13 May, 2019</span></td>
                              <td className="action">
                                  <a href="#" title="Preview" data-tooltip className="action-btn preview"><i className="la la-eye"></i></a>
                                  <a href="#" title="Edit Listing" data-tooltip className="action-btn edit"><i className="la la-edit"></i></a>
                              ...
                              <td className="date"><span>24 Jan, 2018</span></td>
                              <td className="expire-date"><span>Expired</span></td>
                              <td className="action">
                                  <a href="#" title="Edit Listing" data-tooltip className="action-btn edit"><i className="la la-edit"></i></a>
                                  <a href="#" title="Remove" data-tooltip className="action-btn delete"><i className="la la-trash-o"></i></a>
                              </td>
